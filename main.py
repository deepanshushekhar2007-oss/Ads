...
async def main():
    ...
    edit_conv = ConversationHandler(
        ...
        states={WAITING_RUN_COMMAND: [MessageHandler(filters.TEXT & ~filters.COMMAND, receive_run_command)]},
        fallbacks=[CommandHandler("cancel", cancel_handler)],
        per_message=False
    )

    admin_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(button_handler, pattern="^admin_(give_premium|remove_premium|ban|unban|temp_premium|download)$")],
        states={
    ...
    # ---------------- Backup Task ----------------
    application.create_task(backup_system())
